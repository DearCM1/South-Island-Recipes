...
>*This is version 2, which improves on proper browning, roasted vegetables, toasted spices, and an bright, acidic finish to balance the richness.*
...
2. Air fry at 180 °C for 20–30 minutes, tossing every 5 minutes, until the volume of the vegetables have reduced considerably and the edges of the **aubergines** have blackened<sup> Note 1</sup>.
3. Set aside.

### **2. Build the base**

4. Meanwhile, heat a large sauce pot over medium-high heat with a generous amount of olive oil.
5. Add the diced **onions**, **carrots**, and **celery**, season with salt, and cook for 10–15 minutes, allowing them to brown rather than just soften<sup>Note 2</sup>.
6. Add the  **garlic**, **oregano**, **thyme**, **ground coriander**, and **smoked paprika**. Stir for 60–90 seconds until fragrant.
7. Add the **tomato paste**, cook for 1 minute to caramelise it slightly.
	- (Optional) you can add 1 teaspoon of harissa paste for some additional heat and depth.  
8. Pour in the **tinned tomatoes** and stir to combine, add more salt.
9. Add the **stock**, bring to a gentle simmer<sup>Note 3</sup>.

### **3. Lentil time**

10. Once the pot is simmering, add the **lentils** and **tinned beans**.
11. Add **MSG** if using.
12. Reduce to low heat and cook for 35–45 minutes, stirring occasionally<sup>Note 4</sup>.
13. Add more water or stock if the stew thickens too quickly and season throughout, tasting regularly.
...
18. Serve in large, deep bowls.
19. Finish with fresh **basil** or **parsley**, **toasted seeds**, or a drizzle of **extra virgin olive oil** for contrast.
